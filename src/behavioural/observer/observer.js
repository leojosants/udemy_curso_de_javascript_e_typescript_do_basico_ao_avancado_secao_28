...
var InputObservable = /** @class */ (function () {
    ...
    InputObservable.prototype.unsubscrive = function (observer) {
...
function makeParagraph() {
    ...
    p.innerText = 'Sou um P, digite algo no input para verificar se eu serei atualizado';
    return p;
}
function makeDiv() {
    var div = document.createElement('div');
    document.body.appendChild(div);
    div.innerText = 'Sou uma DIV, digite algo no input para verificar se eu serei atualizada.';
    return div;
}
