...
export class ProductComposite extends ProductComponent {
    ...
    getPrice(): number { return this.children.reduce((sum, child) => sum + child.getPrice(), 0); }

    add(...product: ProductComponent[]): void { product.forEach((product) => this.children.push(product)); }
